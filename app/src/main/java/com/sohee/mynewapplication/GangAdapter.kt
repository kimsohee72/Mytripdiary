...
import com.sohee.mynewapplication.dialog.UpdateGang
import com.sohee.mynewapplication.databinding.LayoutItemBinding
import com.sohee.mynewapplication.model.Gang

class GangAdapter : RecyclerView.Adapter<GangAdapter.MyViewHolder>() {

    private var userList = emptyList<Gang>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemLayout.setOnClickListener {
            val intent = Intent(it.context, UpdateGang::class.java)
