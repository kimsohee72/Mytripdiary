...
import com.sohee.mynewapplication.dialog.UpdateJeju
import com.sohee.mynewapplication.model.Jeju

class JejuAdapter : RecyclerView.Adapter<JejuAdapter.MyViewHolder>() {

    private var userList = emptyList<Jeju>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemLayout.setOnClickListener {
            val intent = Intent(it.context, UpdateJeju::class.java)
