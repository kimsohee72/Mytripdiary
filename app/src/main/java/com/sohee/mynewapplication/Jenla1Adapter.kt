...
import com.sohee.mynewapplication.dialog.UpdateJenla1
import com.sohee.mynewapplication.model.Jenla1

class Jenla1Adapter : RecyclerView.Adapter<Jenla1Adapter.MyViewHolder>() {

    private var userList = emptyList<Jenla1>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemLayout.setOnClickListener {
            val intent = Intent(it.context, UpdateJenla1::class.java)
