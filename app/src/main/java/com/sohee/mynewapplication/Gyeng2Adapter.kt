...
import com.sohee.mynewapplication.dialog.UpdateGyeng2
import com.sohee.mynewapplication.model.Gyeng2

class Gyeng2Adapter : RecyclerView.Adapter<Gyeng2Adapter.MyViewHolder>() {

    private var userList = emptyList<Gyeng2>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemLayout.setOnClickListener {
            val intent = Intent(it.context, UpdateGyeng2::class.java)
