...
import com.sohee.mynewapplication.dialog.UpdateGgd
import com.sohee.mynewapplication.model.Ggd


class GgdAdapter : RecyclerView.Adapter<GgdAdapter.MyViewHolder>() {

    private var userList = emptyList<Ggd>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemLayout.setOnClickListener {
            val intent = Intent(it.context, UpdateGgd::class.java)
