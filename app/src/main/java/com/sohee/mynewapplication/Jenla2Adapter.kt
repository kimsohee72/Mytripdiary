...
import com.sohee.mynewapplication.dialog.UpdateJenla2
import com.sohee.mynewapplication.model.Jenla2

class Jenla2Adapter : RecyclerView.Adapter<Jenla2Adapter.MyViewHolder>() {

    private var userList = emptyList<Jenla2>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemLayout.setOnClickListener {
            val intent = Intent(it.context, UpdateJenla2::class.java)
