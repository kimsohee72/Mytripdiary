...
import com.sohee.mynewapplication.databinding.UpdateChung2Binding
import com.sohee.mynewapplication.model.Chung2
import com.sohee.mynewapplication.viewmodel.Chung2ViewModel


class UpdateChung2 : AppCompatActivity() {
    private lateinit var binding : UpdateChung2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.update_chung2)
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = Chung2(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = Chung2(currentId!!,currentPlace,currentFeeling!!)
