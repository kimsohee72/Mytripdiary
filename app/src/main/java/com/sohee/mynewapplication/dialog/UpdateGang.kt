...
import com.sohee.mynewapplication.databinding.UpdateGangBinding
import com.sohee.mynewapplication.model.Gang
import com.sohee.mynewapplication.viewmodel.GangViewModel


class UpdateGang : AppCompatActivity() {
    private lateinit var binding : UpdateGangBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.update_gang)
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = Gang(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = Gang(currentId!!,currentPlace,currentFeeling!!)
