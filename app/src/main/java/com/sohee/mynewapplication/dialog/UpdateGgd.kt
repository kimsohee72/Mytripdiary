...
import com.sohee.mynewapplication.databinding.UpdateGgdBinding
import com.sohee.mynewapplication.model.Ggd
import com.sohee.mynewapplication.viewmodel.GgdViewModel


class UpdateGgd : AppCompatActivity() {
    private lateinit var binding : UpdateGgdBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.update_ggd)
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = Ggd(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = Ggd(currentId!!,currentPlace,currentFeeling!!)
