...
import com.sohee.mynewapplication.databinding.UpdateGyeng2Binding
import com.sohee.mynewapplication.model.Gyeng2
import com.sohee.mynewapplication.viewmodel.Gyeng2ViewModel


class UpdateGyeng2 : AppCompatActivity() {
    private lateinit var binding : UpdateGyeng2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.update_gyeng2)
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = Gyeng2(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = Gyeng2(currentId!!,currentPlace,currentFeeling!!)
