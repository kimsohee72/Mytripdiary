...
import com.sohee.mynewapplication.databinding.UpdateGyeng1Binding
import com.sohee.mynewapplication.model.Gyeng1
import com.sohee.mynewapplication.viewmodel.Gyeng1ViewModel


class UpdateGyeng1 : AppCompatActivity() {
    private lateinit var binding : UpdateGyeng1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.update_gyeng1)
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = Gyeng1(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = Gyeng1(currentId!!,currentPlace,currentFeeling!!)
