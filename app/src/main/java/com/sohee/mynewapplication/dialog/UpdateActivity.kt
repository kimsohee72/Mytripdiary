...
import com.sohee.mynewapplication.databinding.ActivityUpdateBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = User(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = User(currentId!!,currentPlace,currentFeeling!!)
