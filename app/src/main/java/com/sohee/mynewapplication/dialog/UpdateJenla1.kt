...
import com.sohee.mynewapplication.databinding.UpdateJenla1Binding
import com.sohee.mynewapplication.model.Jenla1
import com.sohee.mynewapplication.viewmodel.Jenla1ViewModel

class UpdateJenla1 : AppCompatActivity() {
    private lateinit var binding : UpdateJenla1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = Jenla1(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = Jenla1(currentId!!,currentPlace,currentFeeling!!)
