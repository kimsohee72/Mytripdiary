...
import com.sohee.mynewapplication.databinding.UpdateChung1Binding
import com.sohee.mynewapplication.model.Chung1
import com.sohee.mynewapplication.viewmodel.Chung1ViewModel


class UpdateChung1 : AppCompatActivity() {
    private lateinit var binding : UpdateChung1Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.update_chung1)
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = Chung1(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = Chung1(currentId!!,currentPlace,currentFeeling!!)
