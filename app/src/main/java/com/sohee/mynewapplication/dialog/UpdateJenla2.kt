...
import com.sohee.mynewapplication.databinding.UpdateJenla2Binding
import com.sohee.mynewapplication.model.Jenla2
import com.sohee.mynewapplication.viewmodel.Jenla2ViewModel

class UpdateJenla2 : AppCompatActivity() {
    private lateinit var binding : UpdateJenla2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.updateBtn.setOnClickListener {
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                val user = Jenla2(currentId!!,place,feeling)
        ...
        binding.deleteBtn.setOnClickListener {
            val user = Jenla2(currentId!!,currentPlace,currentFeeling!!)
