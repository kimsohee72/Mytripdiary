...
class CustomDialog(context: Context, Interface: CustomDialogInterface) : Dialog(context) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var placeText : EditText = findViewById(R.id.placeEditView)
        var feelingText : EditText = findViewById(R.id.feelingEditView)
        ...
        addButton.setOnClickListener {
            ...
            val feeling = feelingText.text.toString()
            ...
            // 입력 창이 비어 있지 않을 때
                ...
                customDialogInterface.onAddButtonClicked(place, feeling)
                dismiss()
            }
        }
