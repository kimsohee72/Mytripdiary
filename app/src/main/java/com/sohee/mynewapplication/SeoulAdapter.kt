...
import com.sohee.mynewapplication.dialog.UpdateSeoul
import com.sohee.mynewapplication.model.Seoul


class SeoulAdapter : RecyclerView.Adapter<SeoulAdapter.MyViewHolder>() {

    private var userList = emptyList<Seoul>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemLayout.setOnClickListener {
            val intent = Intent(it.context, UpdateSeoul::class.java)
