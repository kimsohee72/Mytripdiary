...
import com.sohee.mynewapplication.JejuAdapter
import com.sohee.mynewapplication.R
import com.sohee.mynewapplication.databinding.ActivityJejuBinding
...
class jeju : AppCompatActivity(), CustomDialogInterface, SearchView.OnQueryTextListener {

    private lateinit var binding : ActivityJejuBinding
    private lateinit var userViewModel : JejuViewModel
    private val adapter: JejuAdapter by lazy { JejuAdapter() }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_jeju)
