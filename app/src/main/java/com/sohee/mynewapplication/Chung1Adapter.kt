...
import com.sohee.mynewapplication.dialog.UpdateChung1
import com.sohee.mynewapplication.model.Chung1


class Chung1Adapter : RecyclerView.Adapter<Chung1Adapter.MyViewHolder>() {

    private var userList = emptyList<Chung1>()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.itemLayout.setOnClickListener {
            val intent = Intent(it.context, UpdateChung1::class.java)
